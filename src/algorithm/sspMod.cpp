...
namespace OpenOceanKraken
{
    namespace ssp
    {
        void EvaluateSSP(TridMtx &trid, ssp::SSPStructure &SSP, SSP_Mode &ssptype, int iMedium)
        {
         ...
         */
        void Analytic(Eigen::VectorXcd &cp, Eigen::VectorXcd &cs, Eigen::VectorXd &rho, int Medium, int N1)
        {
            int N = N1 - 1;
            int i;
            double h, x, z;
