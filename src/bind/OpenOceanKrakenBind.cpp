...
PYBIND11_MODULE(OpenOceanKraken, module)
{
    ...
    py::class_<Interface>(module, "Interface")
        ...
        .def("setNumThreads", &Interface::setNumThreads)
        .def("setThreadPool", &Interface::setThreadPool, py::keep_alive<1, 2>())
        .def("getNumThreads", &Interface::getNumThreads)
        .def("getHardwareThreads", &Interface::getHardwareThreads)
        .def("from_env", &Interface::from_env)
        .def("from_json", &Interface::from_json)
        .def("to_json", &Interface::to_json)
        .def("to_json_string", &Interface::to_json_string)
        .def("set_Title", [](Interface &self, const std::string &title) {
            std::string copy = title;
            self.set_Title(copy);
        })
        .def("set_Freq", &Interface::set_Freq)
        .def("set_freqvec", &Interface::set_freqvec)
        .def("set_SSP", &Interface::set_SSP)
        .def("set_AttenUnit", &Interface::set_AttenUnit)
        .def("set_Sz", [](Interface &self, const Eigen::VectorXd &values) { self.set_Sz(values); })
        .def("set_Sz", [](Interface &self, double start, double end, int count) { self.set_Sz(start, end, count); })
        .def("set_Rr", [](Interface &self, const Eigen::VectorXd &values) { self.set_Rr(values); })
        .def("set_Rr", [](Interface &self, double start, double end, int count) { self.set_Rr(start, end, count); })
        .def("set_Rz", [](Interface &self, const Eigen::VectorXd &values) { self.set_Rz(values); })
        .def("set_Rz", [](Interface &self, double start, double end, int count) { self.set_Rz(start, end, count); })
        .def("set_Ro", [](Interface &self, const Eigen::VectorXd &values) { self.set_Ro(values); })
        .def("set_Ro", [](Interface &self, double start, double end, int count) { self.set_Ro(start, end, count); })
        .def("set_RProf", [](Interface &self, const Eigen::VectorXd &values) { self.set_RProf(values); })
        .def("set_RProf", [](Interface &self, double start, double end, int count) { self.set_RProf(start, end, count); })
        .def("set_MLimit", &Interface::set_MLimit)
        .def("set_cPhase", &Interface::set_cPhase)
        .def("set_GridType", &Interface::set_GridType)
        .def("set_Rmax", &Interface::set_Rmax)
        .def("set_SourceType", &Interface::set_SourceType)
        .def("set_RunMode", &Interface::set_RunMode)
        .def("set_CoherenceType", &Interface::set_CoherenceType)
        .def("set_ModeType", &Interface::set_ModeType)
        .def("set_Velocity_enable", &Interface::set_Velocity_enable)
        .def("set_ReflCoef_Top", &Interface::set_ReflCoef_Top)
        .def("set_ReflCoef_Bottom", &Interface::set_ReflCoef_Bottom)
        .def("set_SBP", &Interface::set_SBP)
        .def("run", &Interface::run, py::call_guard<py::gil_scoped_release>())
        .def("runEigen", &Interface::runEigen, py::call_guard<py::gil_scoped_release>())
        .def("runField", &Interface::runField, py::call_guard<py::gil_scoped_release>())
        .def("clearResults", &Interface::clearResults)
        .def("free", &Interface::free)
        .def("export_result", &Interface::export_result)
        .def("export_mod", &Interface::export_mod)
        .def("export_shd", &Interface::export_shd)
        .def("get_pressure", [](const Interface &self) { return field_array(self.getPressureCopy()); })
        .def("get_vertical_velocity", [](const Interface &self) { return field_array(self.getVerticalVelocityCopy()); })
        .def("get_horizontal_velocity", [](const Interface &self) { return field_array(self.getHorizontalVelocityCopy()); })
