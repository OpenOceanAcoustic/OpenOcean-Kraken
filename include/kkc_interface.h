...
void set_BottomLine(double zTemp, double alphaR, double alphaI, double betaR, double betaI, double rho); // 设置底部半空间
void set_SurfaceLine(double zTemp, double alphaR, double alphaI, double betaR, double betaI, double rho); // 设置表面半空间
void set_Surface_Grain(double zTemp, double Mz); // 设置表面粒子
void set_Bottom_Grain(double zTemp, double Mz); // 设置底部粒子
